...
This is a basic ldap browser for Mythic v3.4.11+.
This container connects up to RabbitMQ queues for custom browsers and processes data for the custom browser "ldap_browser".
